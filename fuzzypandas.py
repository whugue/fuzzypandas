...
def brute_force_match(a, b, on, how, cutoff):
	pass



def fuzzy_merge(a, b, on, how="left", cutoff=0.6, match_function=brute_force_match):
    ...
    ##Otherwise, proceed to fuzzy-matching non-exact matches
		...
		xwalk = match_function(nomatch_a, nomatch_b, on=on, cutoff=cutoff)
